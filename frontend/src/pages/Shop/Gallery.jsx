            ...
            <div className='container'>
                ...
                <div className="row Gallery fade-up">
                    {products.map((product, index) => (
                        <div key={product._id} className="col-lg-4 col-md-12 mb-4 mb-lg-0">
                            <div className="card">
                                <img
                                    src={product.Image}
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="centered-buttons">
                                      <button type="button" className="btn btn-danger remove-button" onClick={() => handleRemoveFromCart(product._id)}>-</button>
                                      <span className="added-item-count me-3 mt-2">{cartItems[product._id] ? cartItems[product._id].quantity : 0}</span> {' '}
